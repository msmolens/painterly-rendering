                                ...
                                bool copyContext        /* = false */)
{
    ...
    //////
    ///// test to fix float buffers
    ///// http://www.gpgpu.org/forums/viewtopic.php?t=280&highlight=rendertexture+linux
    _pixelFormatAttribs.insert(_pixelFormatAttribs.begin(),
			       _pbufferAttribs.begin(),_pbufferAttribs.end());
    _pixelFormatAttribs.push_back(GLX_DRAWABLE_TYPE);
    _pixelFormatAttribs.push_back(GLX_PBUFFER_BIT);
    //////
